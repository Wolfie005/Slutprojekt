...
class Player(Entity):
    def __init__(self, pos, groups, obstacle_sprites, create_attack, destroy_attack, create_magic):
        ...
        self.image = pygame.image.load('img/player.jpg').convert_alpha()
        ...
        self.max_stats = {'health': 400, 'energy': 300, 'attack': 100, 'magic': 14, 'speed': 14}
        ...
        self.weapon_attack_sound = pygame.mixer.Sound('./player/audio/Sword2.wav')
    ...
    def input(self):
        if not self.attacking:
            ...
            if keys[pygame.K_LEFT] and self.can_switch_magic:
